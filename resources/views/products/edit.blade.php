                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2">
                            <input type="number" name="price" id="price"
                                value="{{ old('name', $product->price) }}" autocomplete="family-name"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6">
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea name="description" id="description" rows="6"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6">{{ old('name', $product->description) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
