<nav class="bg-gray-800" x-data="{ isOpen: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="shrink-0">
                    <a href="/">
                        <img class="size-10" src="/img/logo.png" alt="Your Company"></a>
                </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            ...
            <x-nav-link href="/stock" :active="request()->is('stock')">Stock</x-nav-link>
            <x-nav-link href="/suppliers" :active="request()->is('suppliers')">Suppliers</x-nav-link>
            <x-nav-link href="/customer" :active="request()->is('customer')">Customer</x-nav-link>
        </div>
