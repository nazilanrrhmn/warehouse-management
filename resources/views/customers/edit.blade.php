<x-layout>
    ...
    <form id="customer-form" action="{{ route('customers.update', $customers->id) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2">
                            <input type="text" name="name" id="name"
                                value="{{ old('name', $customers->name) }}" required autocomplete="given-name"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2">
                            <input type="email" name="email" id="email"
                                value="{{ old('email', $customers->email) }}" required autocomplete="email"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2">
                            <input type="number" name="phone" id="phone"
                                value="{{ old('phone', $customers->phone) }}" required autocomplete="phone"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6">
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea name="address" id="address" rows="4" required
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6">{{ old('address', $customers->address) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
